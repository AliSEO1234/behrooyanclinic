...
const BorderLayoutAbout = ({
      ...
      return (
        <>
          {viewportWidth >= 1920 && (
            ...
            <path d="M0.459961 745.381L10.46 739.607V751.154L0.459961 745.381ZM80.501 18.5137H588.559V20.5137H80.501V18.5137ZM609.559 39.5137V725.381H607.559V39.5137H609.559ZM588.559 746.381H9.45996V744.381H588.559V746.381ZM609.559 725.381C609.559 736.979 600.156 746.381 588.559 746.381V744.381C599.052 744.381 607.559 735.874 607.559 725.381H609.559ZM588.559 18.5137C600.157 18.5137 609.559 27.9157 609.559 39.5137H607.559C607.559 29.0203 599.052 20.5137 588.559 20.5137V18.5137Z" fill="#9A62F7"/>
            <g filter="url(#filter0_d_9007_63699)">
            <path d="M79.9716 33.236C87.7764 33.236 94.1034 27.0924 94.1034 19.514C94.1034 11.9355 87.7764 5.79199 79.9716 5.79199C72.1669 5.79199 65.8398 11.9355 65.8398 19.514C65.8398 27.0924 72.1669 33.236 79.9716 33.236Z" fill="#D4C4F7"/>
            </g>
            ...
            <stop stopColor="#C4A8F7"/>
            <stop offset="0.464" stopColor="#9A62F7"/>
            </linearGradient>
            </defs>
            </svg>
          )}
          {viewportWidth >= 1728 && viewportWidth < 1920 && (
            ...
            <path d="M79.3623 37.6921C88.2193 37.6921 95.3994 30.513 95.3994 21.6571C95.3994 12.8012 88.2193 5.62207 79.3623 5.62207C70.5053 5.62207 63.3252 12.8012 63.3252 21.6571C63.3252 30.513 70.5053 37.6921 79.3623 37.6921Z" fill="#D4C4F7"/>
          ...
          {viewportWidth >= 1280 && viewportWidth < 1512 && (
            ...
            <ellipse cx="85.4629" cy="24.2942" rx="17.5566" ry="18.6468" fill="#D4C4F7" fillOpacity="0.4" shapeRendering="crispEdges"/>
            </g>
      ...
      return (
        <>
          {viewportWidth >= 1920 && (
            ...
            <path d="M544.683 474.556L534.683 468.782V480.329L544.683 474.556ZM21.3887 474.556V475.556V474.556ZM601.206 20.5225H21.3887V22.5225H601.206V20.5225ZM0.388672 41.5225V454.556H2.38867V41.5225H0.388672ZM21.3887 475.556L535.683 475.556V473.556L21.3887 473.556L21.3887 475.556ZM0.388672 454.556C0.388672 466.154 9.79069 475.556 21.3887 475.556L21.3887 473.556C10.8953 473.556 2.38867 465.049 2.38867 454.556H0.388672ZM21.3887 20.5225C9.79073 20.5225 0.388672 29.9245 0.388672 41.5225H2.38867C2.38867 31.0291 10.8953 22.5225 21.3887 22.5225V20.5225Z" fill="#9A62F7"/>
            <g filter="url(#filter0_d_5625_15077)">
            <ellipse cx="598.514" cy="21.5222" rx="16.0371" ry="15.9148" fill="#D4C4F7" fillOpacity="0.4" shapeRendering="crispEdges"/>
            </g>
      ...
      return (
        <>
          ...
          {viewportWidth >= 1728 && viewportWidth < 1920 && (
            ...
            <path d="M789.296 805.641L779.296 799.867V811.414L789.296 805.641ZM598.068 19.4004H21.8007V21.4004H598.068V19.4004ZM0.800781 40.4004V785.641H2.80078V40.4004H0.800781ZM21.8008 806.641H780.296V804.641H21.8008V806.641ZM0.800781 785.641C0.800781 797.239 10.2028 806.641 21.8008 806.641V804.641C11.3074 804.641 2.80078 796.134 2.80078 785.641H0.800781ZM21.8007 19.4004C10.2028 19.4004 0.800781 28.8024 0.800781 40.4004H2.80078C2.80078 29.907 11.3073 21.4004 21.8007 21.4004V19.4004Z" fill="#9A62F7"/>
            <g filter="url(#filter0_d_9019_43204)">
            <path d="M599.889 37.7106C608.746 37.7106 615.926 30.5315 615.926 21.6756C615.926 12.8197 608.746 5.64062 599.889 5.64062C591.032 5.64062 583.852 12.8197 583.852 21.6756C583.852 30.5315 591.032 37.7106 599.889 37.7106Z" fill="#D4C4F7"/>
          ...
          {viewportWidth >= 1512 && viewportWidth < 1600 && (
            ...
            <path d="M876.657 757.625L866.657 751.851V763.399L876.657 757.625ZM560.133 20.1934H21.0196V22.1934H560.133V20.1934ZM0.0195312 41.1934V737.625H2.01953V41.1934H0.0195312ZM21.0195 758.625H867.657V756.625H21.0195V758.625ZM0.0195312 737.625C0.0195312 749.223 9.42155 758.625 21.0195 758.625V756.625C10.5261 756.625 2.01953 748.118 2.01953 737.625H0.0195312ZM21.0196 20.1934C9.42158 20.1934 0.0195312 29.5954 0.0195312 41.1934H2.01953C2.01953 30.7 10.5261 22.1934 21.0196 22.1934V20.1934Z" fill="#9A62F7"/>
            <g filter="url(#filter0_d_9012_43116)">
            <path d="M562.057 37.2304C570.914 37.2304 578.094 30.0504 578.094 21.1933C578.094 12.3363 570.914 5.15625 562.057 5.15625C553.2 5.15625 546.02 12.3363 546.02 21.1933C546.02 30.0504 553.2 37.2304 562.057 37.2304Z" fill="#D4C4F7"/>
  ...
  return (
    <section className={`${className ? className : ""} round40 s1280:relative`}>
      ...
      >
        <h2 className="w-fit font-bold text-[15px] s1280:text-[21px] s1512:text-[27px] s1600:text-[31px] s1920:text-[35px] s1280:-mt-2 text-[#333333] z-[4]">
          {title}
        </h2>
      </div>
