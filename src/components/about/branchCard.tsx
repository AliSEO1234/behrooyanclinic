    ...
    <div className="mb-20">
      ...
      <div className="bg-[#E9F1EE] rounded-[40px] py-8 px-6 flex flex-col items-center justify-start gap-y-6 s1280:gap-y-0 s1280:gap-x-4 s1280:flex-row s1280:items-start s1280:justify-between shadow-[0px_4px_4px_#00000040]">
        <div className="s1280:w-[571px] s1512:w-[651px]">
          ...
          <div className="flex items-center justify-between s1280:justify-start gap-x-4">
            {photoList.map((photo, index) => {
              ...
              return (
                <button
                  className={`${endItem && "relative"} w-[67px] h-[67px] s1280:w-[130px] s1280:h-[130px] s1512:w-[150px] s1512:h-[150px] rounded-[20px] overflow-hidden`}
                  key={index}
                >
                  <ImgFetcher src={photo} width={2000} height={2000} className="object-cover" />
                  <div
                    className={`absolute top-0 left-0 w-full h-full bg-[#47474466] items-center justify-center ${
                      endItem ? "flex" : "hidden"
                    }`}
                  >
                    <p className="text-white font-medium s1280:text-[20px]">+5</p>
                  </div>
                </button>
              );
            })}
        ...
        <div className="flex flex-col items-end justify-start s1280:w-[439px] s1512:w-[570px] s1728:w-[600px] gap-y-5">
          <div className="order-2 s1280:order-1 w-[321px] h-[149px] s1280:w-[439px] s1280:h-[300px] s1512:w-[570px] s1512:h-[329px] s1728:w-[600px] rounded-[40px] overflow-hidden -mb-20 s1280:mb-0 s1280:-mt-[90px] shadow-[0px_1px_4px_#00000040]">
            <ImgFetcher src={map} width={2000} height={2000} className="scale-105 object-cover" />
          </div>
