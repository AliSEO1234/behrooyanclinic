...
const TableOfContentCard = ({ icon, label, link }: TableOfContentCardType) => {
  return (
    <Link
      href={`#${link}`}
      className="border-[0.5px] border-dashed border-[#00979A] rounded-[12px] flex-cen w-[80px] h-[80px] s1280:w-[105px] s1280:h-[105px] s1512:w-[125px] s1512:h-[125px] p-2 s1280:p-3 z-10 relative [drop-shadow:0px_0px_8px_0px_#00979A40] group"
    >
      <div className="flex flex-col items-center justify-center gap-y-2 shadow-[0px_0px_8px_0px_#00979A33] rounded-[12px] w-full h-full">
