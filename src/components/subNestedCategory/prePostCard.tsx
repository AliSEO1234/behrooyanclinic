...
const PrePostCard = ({ icon, position }: PrePostCardType) => {
  return (
    <div className="s1280:w-[188px] s1280:min-w-[188px] s1280:h-[188px] s1512:w-[214px] s1512:min-w-[214px] s1512:h-[214px] s1728:w-[221px] s1728:min-w-[221px] s1728:h-[221px] s1920:w-[255px] s1920:min-w-[255px] s1920:h-[255px] rounded-[12px] border-[0.5px] border-none s1280:border-dashed border-[#00979A] s1280:p-3 s1512:p-4 group bg-[#FBFDFD]">
      <div className="flex justify-start gap-x-3 s1280:flex-col items-center s1280:justify-center s1280:gap-y-1 s1280:shadow-[0px_0px_8px_0px_#00979A40] bg-white rounded-[12px] w-full h-full s1728:px-2">
