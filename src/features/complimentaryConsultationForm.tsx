    ...
    <form className="grid grid-cols-12 gap-x-4 gap-y-2 form-platform-work">
      ...
      {/* text-[#474744] */}
        ...
        <ComboBox
          ...
          className="flex-bet s1280:text-[14px] s1728:text-[16px] w-full outline-none h-[38px] s1600:h-[48px] px-4 rounded-[40px] border border-[#9996A0] font-normal text-[#BBBBBB] mb-1 bg-white"
          options={options}
