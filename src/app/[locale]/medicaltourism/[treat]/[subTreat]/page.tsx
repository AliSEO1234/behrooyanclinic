  ...
  return (
    <div>
      ...
      <div className="viewport-p">
        ...
        {/* benefits */}
        <div className="s1512:h-full flex gap-y-[18px] s1280:gap-y-0 s1280:flex-col flex-wrap s1512:flex-nowrap items-center s1512:flex-row s1512:justify-start s1512:items-end s1512:gap-x-[44px]">
