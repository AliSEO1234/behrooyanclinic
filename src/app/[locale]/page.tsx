...
import noIcon from "@/assets/images/icons/experience/noicon.png";
import freeconsul from "@/assets/images/icons/experience/freeconsul.png";
import pay from "@/assets/images/icons/experience/pay.png";
...
import apoint from "@/assets/images/apointment.png";
              ...
              <div className="mt-10 hidden s1280:block">
                <div>
                  ...
                  <p className="font-medium s1280:pe-10 s1600:text-[18px] text-white ">
                    ...
                    comprehensive services, and dedicated 24/7 support
        ...
        <div className="mb-10 s1280:mb-[80px]">
          ...
          <div className="mb-2 s1280:mb-10">
            ...
            <p className="text-center s1280:text-[24px] s1512:text-[28px] s1728:text-[29px] font-normal text-[#333333]">
              We are here to make your medical journey as smooth and reassuring
              as possible, with a dedicated team of doctors, healthcare
          ...
          <div className="col-span-12 s1280:col-span-6 flex flex-col mt-16 s1280:mt-0 px-2 s412:px-4">
            <div className="mb-10 s1280:mb-2">
              ...
              <p className="text-[#474744] font-medium text-[14px] s1512:text-[16px] s1600:text-[18px] s1728:text-[20px] s1512:leading-[30px] text-justify">
                ...
                supporting you to become the best version of yourself. Our team
                of expert doctors and professionals will be continuously by your
