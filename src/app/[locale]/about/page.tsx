...
const Page = async ({ params }: AboutPageType) => {
  ...
  return (
    <div className="bg-[#FCFCFC]">
      {/* header */}
      <div className="bg-about-cover mt-10 w-full h-[283px] s1280:h-[670px] s1512:h-[770px] s1728:h-[900px] s1920:h-[916px] viewport-size rounded-b-[40px] overflow-hidden">
        ...
        <div>
          <AboutTab
            trigerList={[
              {
                keyTrigg: "about",
                title: locale === "ru" ? "О нас" : "About Azpo",
                id: 0,
              },
              {
                keyTrigg: "branch",
                title: locale === "ru" ? "Наши офисы" : "Our branches",
                id: 1,
              },
              {
                keyTrigg: "team",
                title: locale === "ru" ? "Наша команда" : "Our Team",
                id: 2,
              },
            ]}
          >
