  ...
  return (
    <div className="bg-[#FCFCFC]">
      ...
      <div className="bg-about-cover mt-10 w-full h-[283px] s1280:h-[670px] s1512:h-[770px] s1728:h-[900px] s1920:h-[916px] viewport-p rounded-b-[40px] overflow-hidden">
        <div className="s1280:mt-[350px] s1512:mt-[400px] s1728:mt-[500px] text-white hidden s1280:block">
      ...
      <div className="viewport-p">
        ...
        <div>
          <AboutTab
            trigerList={[
              { keyTrigg: "about", title: "About AZPO", id: 0 },
              { keyTrigg: "branch", title: "Our branches", id: 1 },
              { keyTrigg: "team", title: "Our team", id: 2 },
            ]}
          >
            {{
