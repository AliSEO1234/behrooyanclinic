  ...
  return (
    <>
      <div className="pt-28 s1280:pt-40 s1280:pb-20 viewport-p">
        {/* headers */}
        <div className="flex flex-col items-center justify-start gap-y-10 s1280:gap-y-0 s1280:flex-row s1280:items-start s1280:justify-around mb-14 s1280:mb-40">
          <div className="s1280:w-[437px] s1920:w-fit flex flex-col items-center justify-center s1280:flex-row">
            ...
            <div className="flex-cen relative">
              <div className="w-[176px] h-[176px] s1280:w-[348px] s1280:h-[348px] s1728:w-[424px] s1728:h-[424px] s1920:w-[516px] s1920:h-[516px] bg-gradient-to-b from-[#25A6A9] to-[#0F4243] rounded-full backdrop-blur-[20px]"></div>
              ...
              {/* circle */}
              <div className="w-[53px] h-[53px] s1280:w-[104px] s1280:h-[104px] s1728:w-[128px] s1728:h-[128px] s1920:w-[155px] s1920:h-[155px] rounded-full bg-gradient-to-b from-[#0F4243] to-[#25A6A9] absolute -right-5 top-5 s1280:top-10 s1280:-right-5 s1728:-right-5 s1920:-right-14 backdrop-blur-[20px] z-[1] flex-cen p-3 s1280:p-5 s1920:p-7">
                <ImgFetcher src={pres} width={6000} height={6000} />
              </div>
              <div className="w-[82px] h-[82px] s1280:w-[160px] s1280:h-[160px] s1728:w-[196px] s1728:h-[196px] s1920:w-[238px] s1920:h-[238px] rounded-full bg-gradient-to-b from-[#0F4243] to-[#25A6A9] absolute -bottom-5 -left-5 s1280:-bottom-14 s1280:-left-10 s1728:-left-5 s1920:-left-20 backdrop-blur-[20px] z-[1] p-3 s1280:p-5 s1728:p-7 s1920:p-9">
        ...
        <div>
          {/* bg */}
          <div className="w-full h-[54px] s1280:h-[138px] bg-gradient-to-b from-[#25A6A9] to-[#0F4243] backdrop-blur-[20px] rounded-[20px] z-[1]"></div>
          {/* clinics */}
